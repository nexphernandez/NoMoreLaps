...
/**
 * Persistence secondary port for {@link DynamicPriceJpaEntity}.
 *
 * @author nexphernandez DiazLuisAlejandro
 * @version 1.0.0
 */
public interface IDynamicPricePersistenceAdapter extends IBasePersistenceAdapter<DynamicPriceJpaEntity, Long> {
    /**
